...
export const postRegisterAdminAction = createAsyncThunk(
  "users/postRegisterAdmin",
...
export const postRegisterManagerAction = createAsyncThunk(
  "users/postRegisterManager",
  async (payload, thunkAPI) => {
...
export const postRegisterEmployeeAction = createAsyncThunk(
  "users/postRegisterEmployee",
  async (payload, thunkAPI) => {
...
export const postUserPhotoAction = createAsyncThunk(
  "users/postUserPhoto",
  async (payload, thunkAPI) => {
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getUserAction.pending, (state) => {
      ...
      builder.addCase(
        postRegisterAdminAction.fulfilled,
        (state, { payload }) => {
          state.message = payload;
          state.isLoading = false;
        }
      ...
      builder.addCase(
        postRegisterManagerAction.fulfilled,
        (state, { payload }) => {
          state.message = payload;
          state.isLoading = false;
        }
      ...
      builder.addCase(
        postRegisterEmployeeAction.fulfilled,
        (state, { payload }) => {
          state.message = payload;
          state.isLoading = false;
        }
    ...
    builder.addCase(postUserPhotoAction.pending, (state) => {
      ...
      builder.addCase(postUserPhotoAction.fulfilled, (state, { payload }) => {
        state.message = payload;
        state.current.profileImageUrl = payload.data.imageUrl;
        state.isLoading = false;
      }),
