...
export default function ProfileUser() {
  ...
  const handlePhoto = async () => {
    if (userPhoto != null) {
      ...
      data.append("userId", current.userId);
    ...
    <div className="card container d-flex flex-row justify-content-around align-items-center rounded-8 shadow-lg w-75 border-0">
      <div className="d-flex flex-column p-4 w-50">
        <img
          ...
          className="card-img-top img-fluid img-responsive justify-content-end bg-black align-self-center"
          alt="profile-image"
        ...
        {editPhoto ? (
          <div className="p-3">
            ...
            <div className="d-flex justify-content-center gap-2">
              <button
                onClick={handlePhoto}
                className="btn btn-info my-4 w-25 align-self-end"
              >
                Upload
              </button>
              <button
      ...
      <div className="d-flex flex-column card-body p-4 w-50 align-self-end">
        <div>
          ...
          <p className="card-text text-center">
            {current.userCredentialResponse.role}
          </p>
        ...
        <button
          ...
          className="btn btn-info my-4 align-self-end"
        >
          Edit Data
        </button>
      </div>
