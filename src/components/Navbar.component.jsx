...
const NavbarComponent = () => {
  ...
  return (
    <div
      className={
        "d-flex flex-column justify-content-between text-white rounded-end-5 py-4 ps-2 pe-1 h-100 bg-primary"
      }
    >
      ...
      <nav className="p-4 overflow-hidden">
        <ul className="d-flex flex-column gap-3 nav-list list-unstyled">
          ...
          {(user.role == "ROLE_ADMIN" || user.role == "ROLE_MANAGER") && (
            <>
              <li
                ...
                data-bs-target="#dashboard-collapse-1"
                aria-expanded="true"
              >
                <i className="me-3">
                  <IconHomeCog />
          ...
          <li
            className="cursor-pointer text-white"
            data-bs-toggle="collapse"
            data-bs-target="#dashboard-collapse-2"
            aria-expanded="true"
          >
            <i className="me-3">
              <IconHomeCog />
      ...
      <h2 className="fs-6 my-4 font-primary">@EnigmaCamp</h2>
    </div>
  );
};
